...
const SignupPage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        console.log("Signup submitted:", { userType, name, email, password, employeeId });
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-center gap-4">
                        <button
                            ...
                            className={`flex-1 py-3 px-4 text-sm font-semibold rounded-lg border ${userType === "citizen"
                        ...
                        <button
                            ...
                            className={`flex-1 py-3 px-4 text-sm font-semibold rounded-lg border ${userType === "department"
                                ? "bg-indigo-600 text-white"
                                : "bg-white text-gray-700 border-gray-300"
                                } shadow-md transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-500`}
                        >
